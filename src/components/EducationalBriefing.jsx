...
const BRIEFING_CONTENT = {
  ...
  5: {
    ...
    threat: {
      ...
      displayCount: 3,
      factPool: [
        { id: 'l5t1', icon: '🗺️', text: 'Israel faces threats from 5 directions simultaneously — Gaza (west), Lebanon (north), Syria (northeast), Iran (east), and Yemen (southeast)' },
        { id: 'l5t2', icon: '🇾🇪', text: 'Yemen\'s Houthi rebels, backed by Iran, have launched ballistic missiles and drones at Israel from over 2,000 km away — the farthest threat origin' },
        { id: 'l5t3', icon: '🔗', text: 'Iran\'s "Axis of Resistance" coordinates attacks across all fronts — Gaza, Lebanon, Syria, Iraq, and Yemen can strike simultaneously' },
        { id: 'l5t4', icon: '📐', text: 'Defending 360° is exponentially harder than one front — operators must constantly scan the entire radar for threats from any direction' },
        { id: 'l5t5', icon: '🌍', text: 'Israel is one of the smallest countries facing multi-front missile threats — the entire country is only 470 km long and 135 km wide at its widest' },
        { id: 'l5t6', icon: '⏱️', text: 'A ballistic missile from Iran reaches Israel in under 12 minutes, while a drone from Yemen takes 4+ hours — defenders must handle vastly different timelines' },
      ],
      animation: 'layered',
    },
    defense: {
      ...
      displayCount: 3,
      factPool: [
        { id: 'l5d1', icon: '🛡️', text: 'Israel\'s multi-layered defense assigns each system to specific threat types — Iron Dome for rockets/drones, David\'s Sling for cruise missiles, Arrow for ballistic' },
        { id: 'l5d2', icon: '📡', text: 'The entire system is connected by a unified command network — operators see all threats on one screen regardless of origin direction' },
        { id: 'l5d3', icon: '🎯', text: 'Each interceptor battery protects a zone — multiple batteries spread across the country provide overlapping coverage' },
        { id: 'l5d4', icon: '🧠', text: 'Deciding which threats to intercept and which to let pass (hold fire) becomes critical when threats come from every direction simultaneously' },
        { id: 'l5d5', icon: '📏', text: 'Israel has deployed Iron Dome batteries from Eilat in the south to Haifa in the north — each covering a specific region' },
        { id: 'l5d6', icon: '🔄', text: 'During multi-front attacks, interceptor batteries can be repositioned within hours to reinforce the most threatened areas' },
      ],
  ...
  6: {
    ...
    threat: {
      ...
      displayCount: 3,
      factPool: [
        { id: 'l6t1', icon: '⚡', text: 'Hypersonic weapons travel at Mach 5+ — over 6,000 km/h' },
        { id: 'l6t2', icon: '🌍', text: 'They boost to the edge of space, then glide back at extreme speed while maneuvering' },
        { id: 'l6t3', icon: '📡', text: 'Their ability to change course mid-flight makes them nearly impossible to predict' },
        { id: 'l6t4', icon: '🇷🇺', text: 'Russia, China, Iran, and North Korea are all developing hypersonic weapons — Russia\'s Avangard can reportedly reach Mach 20' },
        { id: 'l6t5', icon: '🔥', text: 'At Mach 5+, air friction heats the weapon\'s surface to over 2,000\u00b0C — requiring special heat-resistant materials to survive the flight' },
        { id: 'l6t6', icon: '⏱️', text: 'A hypersonic weapon at Mach 7 crosses 100 km in about 50 seconds — leaving almost no time for traditional defense systems to react' },
      ],
    ...
    defense: {
      ...
      displayCount: 3,
      factPool: [
        { id: 'l6d1', icon: '🌌', text: 'Intercepts targets in space — outside the atmosphere, before reentry' },
        { id: 'l6d2', icon: '🚀', text: 'Uses hit-to-kill technology — pure kinetic energy, no explosive warhead needed' },
        { id: 'l6d3', icon: '📏', text: 'Can engage threats at altitudes over 100 km — the highest layer of Israeli defense' },
        { id: 'l6d4', icon: '🏭', text: 'Developed by Israel Aerospace Industries (IAI) with support from the US Missile Defense Agency' },
        { id: 'l6d5', icon: '🧪', text: 'Successfully tested against a real ballistic target in space in 2019 — proving the system works in actual combat conditions' },
        { id: 'l6d6', icon: '🌐', text: 'Destroying threats in space means debris burns up on reentry — protecting people on the ground from falling warhead fragments' },
      ],
      animation: 'arrow_3',
    },
    exerciseConfig: {
